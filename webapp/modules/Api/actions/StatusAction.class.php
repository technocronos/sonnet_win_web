 ...
 * ステータス画面の情報を取得する
 */
class StatusAction extends SmfBaseAction {
    ...
    protected function doExecute($params) {
        ...
        foreach($mounts as $mount){
            if($chara['equip'][$mount['mount_id']]['set_id']){
                ...
                $chara['equip'][$mount['mount_id']]['set_id'] = 0;
                $chara['equip'][$mount['mount_id']]['rear_id'] = 0;
                $chara['equip'][$mount['mount_id']]['set_name'] = 0;
                $chara['equip'][$mount['mount_id']]['set_text'] = 0; 
            }
        }
