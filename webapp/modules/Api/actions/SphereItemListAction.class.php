 ...
 */
class SphereItemListAction extends SmfBaseAction {
...
//Common::varLog($itemTable);
          ...
          $uitemlist = Service::create('User_Item')->getRecordsIn(array_keys($itemTable), false);
          $uitems = ResultsetUtil::colValues($uitemlist, 'item_id', 'user_item_id');
          $uitemsEvol = ResultsetUtil::colValues($uitemlist, 'evolution', 'user_item_id');
          ...
          foreach($unit_items as $slot => $uitemId) {
                ...
                if($item['category'] == "ITM"){
                    ...
                    $item["useable"] = true;
                    $item["evolution"] = $uitemsEvol[$uitemId];
                }
