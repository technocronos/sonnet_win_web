...
class MPC_Common
{
    ...
    * @var string
    */
    var $i_img_path = 'img/emoji/i/';
    
    /**
    * EZweb絵文字画像格納パス
    * @var string
    */
    var $e_img_path = 'img/emoji/e/';
    
    /**
    * SoftBank絵文字画像格納パス
    * @var string
    */
    var $s_img_path = 'img/emoji/s/';
        ...
        switch($this->getOption()) {
            case MPC_TO_OPTION_RAW:
                ...
                if ($this->getFromCharset() === 'SJIS') {
					...
					if($this->getTo() == MPC_TO_IPHONE && $this->getPurpose() === "html5" ){
						//スマホでHTML5変換の場合はsjisにエンコードして返す
...
*/
            ...
            case MPC_TO_OPTION_IMG:
                ...
                $buf = '<img src="'.$this->path . rtrim($this->s_img_path, '/').'/'.$dec.'.gif" alt="" border="0" width="'.$width.'" height="15" />';
                break;
        }
        return $buf;
    }
