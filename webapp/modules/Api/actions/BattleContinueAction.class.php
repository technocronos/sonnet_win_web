 ...
 */
class BattleContinueAction extends SmfBaseAction {

    protected function doExecute($params) {

        // 指定されたバトルの状態が開始されるに適当かどうかチェックして、開始処理を行う。
        $result = $this->ContinueBattle($params);
    ...
    private function ContinueBattle($params) {
        ...
        if($this->user_id != $battle['player_id']) {
            ...
            return array('result'=>'error', 'err_code'=>'not_my_battle');
        }
